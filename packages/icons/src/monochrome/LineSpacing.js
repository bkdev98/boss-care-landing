...
export default function LineSpacing(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} {...props}>
      <path className="uim-tertiary" d="M21 8H10a1 1 0 0 1 0-2H21a1 1 0 0 1 0 2zM21 13H10a1 1 0 0 1 0-2H21a1 1 0 0 1 0 2z" />
      <path className="uim-primary" d="M4.667,18.5a.99943.99943,0,0,1-1-1V6.5a1,1,0,0,1,2,0v11A.99942.99942,0,0,1,4.667,18.5Z" />
      <path className="uim-tertiary" d="M21,18H10a1,1,0,0,1,0-2H21a1,1,0,0,1,0,2Z" />
